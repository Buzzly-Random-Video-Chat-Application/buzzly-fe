...
import WaitingConnectionCard from './desktop/WaitingConnectionCard';
import ConnectingCard from './desktop/ConnectingCard';
...
export default VideoChatDesktop;